    ...
    return (
        <div className='pb-10 md:py-20 mx-2'>
            ...
            <div className='relative w-full max-w-3xl overflow-hidden m-auto rounded-xl'>
                ...
                {/* slider  */}
                <input type="range" min={0} max={100} className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full z-10 slider' value={sliderPosition} onChange={handlerSliderChange} name="" id="" />
            </div>
        </div>
    )
}
