    ...
    return (
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>Our free background remover AI tool removes <br className='max-sm:hidden' /> backgrounds in less than 3 seconds using advanced AI.</p>
                <div>
